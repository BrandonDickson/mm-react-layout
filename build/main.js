...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Padding = exports.Margin = exports.Layout = exports.FlexBoxItem = exports.FlexBox = exports.padding = exports.margin = exports.layout = exports.flexBoxItem = exports.flexBox = exports.createWrapperComponent = exports.mergeHOC = undefined;
	
	var _createWrapperComponent = __webpack_require__(1);
	...
	var FlexBoxItem = mergeHOC((0, _createWrapperComponent2.default)('FlexBoxItem'), _margin2.default, _padding2.default, _flexBoxItem2.default);
	
	var Layout = mergeHOC((0, _createWrapperComponent2.default)('Layout'), _margin2.default, _padding2.default, _flexBox2.default, _flexBoxItem2.default);
	
	var Margin = mergeHOC((0, _createWrapperComponent2.default)('Margin'), _margin2.default);
	
	var Padding = mergeHOC((0, _createWrapperComponent2.default)('Padding'), _padding2.default);
	
	exports.mergeHOC = mergeHOC;
	exports.createWrapperComponent = _createWrapperComponent2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (name) {
	  ...
	  var WrapperComponent = function WrapperComponent(_ref) {
	    ...
	    return component ? _react2.default.createElement(component, _extends({ children: children }, rest)) : _react2.default.cloneElement(children, rest);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var alignTypes = ['flex-start', 'flex-end', 'space-around', 'space-between', 'stretch', 'center'];
	
	var propTypes = {
	  direction: _react2.default.PropTypes.oneOf(['row', 'row-reverse', 'column', 'column-reverse']),
	  alignContent: _react2.default.PropTypes.oneOf(alignTypes),
	  justifyContent: _react2.default.PropTypes.oneOf(alignTypes)
	};
	
	exports.default = function (component) {
	
	  var FlexBoxWrapper = function FlexBoxWrapper(_ref) {
	    var direction = _ref.direction,
	        align = _ref.align,
	        justify = _ref.justify,
	        style = _ref.style,
	        rest = _objectWithoutProperties(_ref, ['direction', 'align', 'justify', 'style']);
	  ...
	  return Object.assign(FlexBoxWrapper, { propTypes: propTypes });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var lookup = {
	  'none': { flex: '0 0 auto', boxSizing: boxSizing },
	  'initial': { flex: '0 1 auto', boxSizing: boxSizing },
	  'nogrow': { flex: '0 1 auto', boxSizing: boxSizing },
	  'grow': { flex: '1 1 100%' },
	  'auto': { flex: '1 1 auto' },
	...
	exports.default = function (component) {
	  ...
	  var FlexBoxItemWrapper = function FlexBoxItemWrapper(_ref) {
	    var flex = _ref.flex,
	        alignSelf = _ref.alignSelf,
	        order = _ref.order,
	        offset = _ref.offset,
	        style = _ref.style,
	        rest = _objectWithoutProperties(_ref, ['flex', 'alignSelf', 'order', 'offset', 'style']);
	
	    return _react2.default.createElement(component, _extends({
	      style: _extends({}, style, flex && _extends({}, lookup[flex] || {
	        flex: '1 1 ' + flex + '%',
	        maxWidth: flex + '%',
	        maxHeight: '100%',
	        boxSizing: boxSizing
	      }, alignSelf && { alignSelf: alignSelf }, order && { flexOrder: order }, offset && { marginLeft: offset + '%' }))
	    }, rest));
	  };
	
	  return Object.assign(FlexBoxItemWrapper, { propTypes: propTypes });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var propTypes = {
	  padding: _react2.default.PropTypes.oneOfType([_react2.default.PropTypes.oneOf(Object.keys(lookup)), _react2.default.PropTypes.number])
	};
	
	exports.default = function (component) {
	
	  var PaddingWrapper = function PaddingWrapper(_ref) {
	    var padding = _ref.padding,
	        style = _ref.style,
	        rest = _objectWithoutProperties(_ref, ['padding', 'style']);
	
	    return _react2.default.createElement(component, _extends({
	      style: _extends({}, style, padding && {
	        padding: lookup[padding] || padding
	      })
	    }, rest));
	  };
	
	  return Object.assign(PaddingWrapper, { propTypes: propTypes });
	};
